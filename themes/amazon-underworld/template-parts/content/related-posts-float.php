...
<div class="related-posts related-posts-float container container--wide">
    <h2 class="related-posts__title related-posts-float__title">
        <?php if($post_type === 'post'){
            _e('Explore more content', 'hacklabr') ?></h2>
        <?php } else {
            _e('Explore more ' . $post_type_obj->label, 'hacklabr') ?></h2>
        <?php } ?>
        <div class="related-posts__content related-posts-float__content">
